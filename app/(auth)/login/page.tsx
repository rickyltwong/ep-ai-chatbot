...
export default function Page() {
  ...
  useEffect(() => {
    ...
    if (error === 'AccountExists') {
      toast({
        type: 'error',
        description: 'This email already exists. Please sign in with your password instead.',
      });
        ...
        <div className="flex flex-col items-center justify-center gap-2 px-4 text-center sm:px-16">
          ...
          {error === 'AccountExists' && (
            <div className="mt-4 p-3 bg-amber-100 dark:bg-amber-900 border border-amber-300 dark:border-amber-800 rounded-md text-amber-800 dark:text-amber-200 text-sm">
              <strong>Account exists!</strong> This email is already registered with a password. Please sign in with your credentials instead of using Google.
            </div>
          )}
          {error === 'AccessDenied' && (
          ...
          <div className="mt-4">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-background text-gray-500 dark:text-zinc-400">Or continue with</span>
              </div>
            </div>
